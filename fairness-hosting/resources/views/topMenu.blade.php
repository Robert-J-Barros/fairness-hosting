<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <section class="container">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cloud-haze2 logo FontsForProject" viewBox="0 0 16 16">
        ...
        <div class="collapse navbar-collapse PositionNavBar" id="navbarNav">
            ...
            <li class="nav-item active ">
                <a class="nav-link PositionLinkNavBar FontsForProject" href="#">Website Builder <span class="sr-only"></span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link PositionLinkNavBar FontsForProject" href="#">Hosting</a>
            </li>
            <li class="nav-item">
                <a class="nav-link PositionLinkNavBar FontsForProject" href="#">Dominios</a>
            </li>
            <li class="nav-item">
                <button type="button" class="btn btn-outline-dark FontsForProject">Login</button>
                </li>
            </ul>
        </div>
    </section>
